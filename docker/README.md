...
```bash
curl "http://geomet-dev-32.edc-mtl.ec.gc.ca:5091/service?request=GetCapabilities"
# or
curl "https://geomet-dev-32-nightly.edc-mtl.ec.gc.ca/geomet-mapproxy/service?request=GetCapabilities"
```
